...
<div class="container m-5">
    ...
    <div class="list-group list-group-numbered mt-4">
        ...
        <!-- this is not working, because regex expression, only accept letter A-Z or a-z without special character like - -->
    ...
    <div class="list-group list-group-numbered my-4">
